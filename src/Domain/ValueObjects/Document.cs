    ...
    public class Document : ValueObject
    {
        ...
        public static Result<Document> Create(string document)
        {
            if (string.IsNullOrWhiteSpace(document))
                return Result.Failure<Document>("O documento não pode ser vazio");
            ...
            return Result.Failure<Document>("Documento inválido. Deve ser CPF (11 dígitos) ou CNPJ (14 dígitos)");
        }
